      ...
      <div className="bg-surface border border-emerald-500/20 rounded-xl p-4">
        ...
        <ul className="space-y-2">
          {dos.map((item, index) => (
            <li
              key={index}
              className="text-sm md:text-base leading-relaxed text-ink/80 font-thai pl-3 relative before:content-['·'] before:absolute before:left-0 before:text-emerald-400"
            >
              {item}
            </li>
          ))}
      ...
      <div className="bg-surface border border-amber-500/20 rounded-xl p-4">
        ...
        <ul className="space-y-2">
          {donts.map((item, index) => (
            <li
              key={index}
              className="text-sm md:text-base leading-relaxed text-ink/80 font-thai pl-3 relative before:content-['·'] before:absolute before:left-0 before:text-amber-400"
            >
              {item}
            </li>
          ))}
